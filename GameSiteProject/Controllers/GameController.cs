...
namespace GameSiteProject.Controllers
{
    public class GameController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("GameId,Title,Genre,Developer,Publisher,ReleaseDate,Description,CoverImagePath")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GameId,Title,Genre,Developer,Publisher,ReleaseDate,Description,CoverImagePath")] Game game)
        {
            if (id != game.GameId)
            {
                return NotFound();
